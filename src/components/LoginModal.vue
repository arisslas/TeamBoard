    ...
    <div class="wrapper fadeInDown" id="fondo">
        <div id="formContent">
            ...
            <form @submit.prevent="onSubmit" class="formulario">
                <input id='email' class="fadeIn second" type="text" placeholder="email" autocomplete="off"
                    v-on:keyup='onKeyUp($event)' />
                <input id='password' class="fadeIn third" type="password" placeholder="password"
                    v-on:focus='secret()' v-on:blur='nosecret()' />
                <div>
                    <div id="boton">
...
export default {
    ...
    methods: {
        ...
        onSubmit(submitEvent){
          ...
          // if mail and pass truthy
          //this.singIn(this.mail,this.password);   
          // this.getUser();
